...
const CartDrawer = () => {
  ...
  return (
    <>
      ...
      />
      {/* Drawer Container */}
      <div className="fixed top-0 right-0 h-dvh w-[90%] sm:w-[50%] md:w-[50%] lg:w-[33%] bg-white z-50 shadow-2xl flex flex-col overflow-hidden animate-slide-in transition-transform duration-300 ease-in-out">
        <CartPage />
      </div>
    </>
  );
